...
export interface PluginDxpWebsite extends Schema.CollectionType {
  ...
  attributes: {
    ...
    hostname: Attribute.String & Attribute.Unique;
...
export interface PluginDxpWebpage extends Schema.CollectionType {
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'plugin::dxp.website': PluginDxpWebsite;
      'plugin::dxp.webpage': PluginDxpWebpage;
